...
import EditQuestion from "../quizz/EditQuestion";
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<PrivateRouteGuard element={<Welcome />} />}
      />
      <Route
        path="/holocron-trivia/public"
        element={<PrivateRouteGuard element={<Ranked />} />}
      />
      <Route
      ...
      <Route
        ...
        element={<AdminRouteGuard element={<EditQuestion />} />}
      />
